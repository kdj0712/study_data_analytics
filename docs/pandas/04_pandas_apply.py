...
# df_datetimes['완료일_한글_datetime'] = df_datetimes['완료일_한글_datetime'].apply(convert_time)

def recieve_params(params):
    # params.loc['신청일']
    # '2018.12.27'
    # params.loc['완료일_한글']
    # '2019-01-11 오후 05:32'
...
df_datetimes[['완료일_한글','신청일']].apply(recieve_params, axis=1)
pass